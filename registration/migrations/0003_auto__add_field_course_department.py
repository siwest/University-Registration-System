...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'registration_course', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['registration.Department']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.department'
        db.delete_column(u'registration_course', 'department_id')
