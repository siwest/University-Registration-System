...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'registration_course', 'code')

        # Adding field 'Course.number'
        db.add_column(u'registration_course', 'number',
                      self.gf('django.db.models.fields.CharField')(default=101, max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Course.code'
        db.add_column(u'registration_course', 'code',
                      self.gf('django.db.models.fields.CharField')(default=101, max_length=20),
                      keep_default=False)

        # Deleting field 'Course.number'
        db.delete_column(u'registration_course', 'number')
