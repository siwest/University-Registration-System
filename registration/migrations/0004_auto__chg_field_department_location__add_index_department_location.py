...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Department.location' to match new field type.
        db.rename_column(u'registration_department', 'location', 'location_id')
        # Changing field 'Department.location'
        db.alter_column(u'registration_department', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.Location']))
        # Adding index on 'Department', fields ['location']
        db.create_index(u'registration_department', ['location_id'])


    def backwards(self, orm):
        # Removing index on 'Department', fields ['location']
        db.delete_index(u'registration_department', ['location_id'])


        # Renaming column for 'Department.location' to match new field type.
        db.rename_column(u'registration_department', 'location_id', 'location')
        # Changing field 'Department.location'
        db.alter_column(u'registration_department', 'location', self.gf('django.db.models.fields.CharField')(max_length=50))
