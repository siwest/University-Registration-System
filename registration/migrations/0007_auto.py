...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field faculty_members on 'Department'
        m2m_table_name = db.shorten_name(u'registration_department_faculty_members')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field faculty_members on 'Department'
        db.delete_table(db.shorten_name(u'registration_department_faculty_members'))
    ...
    models = {
        ...
        u'registration.department': {
            ...
            'faculty_members': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['registration.FacultyMember']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
